  ...
  return (
    <div className="w-full max-w-[1400px] mx-auto p-4 md:p-8 lg:p-12 flex flex-col gap-8 pb-24">
      <header className="flex flex-col md:flex-row justify-between items-start md:items-end gap-4 animate-fade-in">
        <div>
          <p className="text-primary font-bold tracking-wider text-sm uppercase mb-1">Visão Geral</p>
          <h2 className="text-3xl md:text-4xl font-black text-[#1c130d] dark:text-white tracking-tight">Painel de Loot</h2>
        </div>
        <div className="flex items-center gap-3 bg-white dark:bg-surface-dark px-4 py-2 rounded-full shadow-sm border border-gray-100 dark:border-gray-800">
          <div className="flex items-center gap-1.5">
            ...
            <span className="text-sm font-medium text-gray-600 dark:text-gray-300">Servidor Online</span>
          </div>
          <span className="text-gray-300 dark:text-gray-700">|</span>
          <span className="text-sm font-bold text-[#1c130d] dark:text-white">{items.length} Itens Ativos</span>
        </div>
      </header>
              ...
              <div className="w-full flex flex-col gap-4 bg-gray-50/50 dark:bg-white/5 rounded-2xl p-4 border border-gray-100 dark:border-gray-800/50 flex-1">
                <div className="flex items-center justify-between pb-2 border-b border-gray-200 dark:border-gray-700">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs font-bold text-gray-500 uppercase tracking-wider">Prioridade</span>
                  </div>
                  {userRank && (
                ...
                <div className="flex flex-col gap-2">
                  {queue.length > 0 ? queue.map((player, index) => {
                    ...
                    <div className="text-center py-4 text-xs text-gray-400">Ninguém na fila</div>
                  )}
                </div>
              </div>
