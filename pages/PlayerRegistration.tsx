...
const PlayerRegistration: React.FC = () => {
    ...
    const classAvatars: Record<ClassType, string> = {
        'Elfa': 'https://api.dicebear.com/7.x/avataaars/svg?seed=Elf&backgroundColor=c0aede',
        'Mago': 'https://api.dicebear.com/7.x/avataaars/svg?seed=Mage&backgroundColor=b6e3f4',
        'Lorde': 'https://api.dicebear.com/7.x/avataaars/svg?seed=Lord&backgroundColor=ffdfbf',
        'Cavaleiro': 'https://api.dicebear.com/7.x/avataaars/svg?seed=Knight&backgroundColor=c0aede'
    };
            ...
            reader.onload = (readerEvent) => {
                ...
                img.onload = () => {
                    ...
                    if (dataUrl.length > 1000 * 1024) {
                        alert("A imagem ainda é muito grande após compressão.");
                        return;
                    }
                ...
                <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
                    <div>
                        <div className="flex items-center gap-2 text-primary font-medium mb-2">
                            ...
                            <span className="text-sm uppercase tracking-wider">Gestão</span>
                        </div>
                        <h2 className="text-3xl md:text-4xl font-black text-[#1c130d] dark:text-white tracking-tight">Cadastro de Jogadores</h2>
                        <p className="text-gray-500 dark:text-gray-400 mt-2 text-lg">Gerencie os membros da guilda, seus CPs e classes.</p>
                    </div>
                </div>
